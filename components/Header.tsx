...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 bg-white shadow-md z-50 mb-10">
      <div className="container mx-auto px-4 py-15 my-2 flex justify-between items-center">
        ...
        <div className="md:hidden bg-white border-t">
          <div className="container mx-auto px-4 py-3">
            <nav className="flex flex-col space-y-3">
              ...
              <Link href="/about-us" className="text-gray-800 hover:text-brand-teal py-2">
                About Us
              </Link>
              <Link href="/contact-us" className="text-gray-800 hover:text-brand-teal py-2">
                Contact
              </Link>
            </nav>
          </div>
